...
const RevieWatanatham = () => {
  const Watanatham = DataPlaces();

  const isGetDatas = Watanatham.filter(item => item.category_name === 'ວັດທະນາທຳ');
        ...
        <div>
          <div className="boxmenu grid grid-cols-2 md:grid-cols-3  gap-4 ">
            {isGetDatas ? (
              ...
              <p className="flex justify-center items-center"> ຂໍອະໄພບໍ່ມີຂໍ້ມູນ</p> 
...
export default RevieWatanatham;
